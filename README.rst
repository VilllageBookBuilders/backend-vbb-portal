...
(to run windows)
    1. py -m pip install --user virtualenv 2. py -m venv env 3. env\Scripts\activate.bat 4. pip install -r requirements.txt 5. npm i 6. npm run build 7.python manage.py runserver 8. python manage.py migrate
