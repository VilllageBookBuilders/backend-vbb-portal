...
from vbb_backend.program.api.serializers.programManager import ManagerProgramSerializer
from vbb_backend.program.models import Program, ManagersProgramAssociation
from vbb_backend.users.models import UserTypeEnum


class ManagerProgramViewSet(ModelViewSet):
    queryset = ManagersProgramAssociation.objects.all()
    permission_classes = [IsAuthenticated, DRYPermissions]
    serializer_class = ManagerProgramSerializer
